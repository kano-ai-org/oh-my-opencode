...
</Category_Context>`}var jt=`<Category_Context>
...
</Caller_Warning>`,kt=`<Category_Context>
...
Minimal status updates. Focus on results, not play-by-play. Report completion with summary of changes.
</Category_Context>`,resolvePromptAppend:et,requiresModel:"gpt-5.6-sol"},{name:"quick",config:{model:"kimi-coding/kimi-for-coding-highspeed"},description:"Trivial tasks - single file changes, typo fixes, simple modifications",promptAppend:jt},{name:"unspecified-low",config:{model:"openai/gpt-5.6-luna",variant:"xhigh"},description:"Tasks that don't fit other categories, low effort required",promptAppend:kt}];var p=[...L,...y,...v,...U],Cn=Object.fromEntries(p.map((t)=>[t.name,t.config])),Mn=Object.fromEntries(p.map((t)=>[t.name,t.description])),vn=Object.fromEntries(p.map((t)=>[t.name,t.promptAppend]));function Wt(t){return t.requiresModel!==void 0}var Ln=Object.fromEntries(p.filter(Wt).map((t)=>[t.name,t.requiresModel]));var Un=Object.fromEntries(p.filter(Vt).map((t)=>[t.name,t.resolvePromptAppend]));function Vt(t){return t.resolvePromptAppend!==void 0}var l=Object.freeze({type:"boolean"}),x=Object.freeze({type:"number"}),o=Object.freeze({type:"string"});function f(t){return Object.freeze({type:"string",values:Object.freeze(t)})}var J=Object.freeze({anthropic:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),"anthropic-api":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),deepseek:Object.freeze(["deepseek-v4-flash","deepseek-v4-pro"]),google:Object.freeze(["gemini-3.6-flash"]),"github-copilot":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","gpt-5.6-sol","gpt-5.6-terra"]),"kimi-for-coding":Object.freeze(["k3","kimi-for-coding-highspeed","kimi-k3"]),moonshotai:Object.freeze(["kimi-k3"]),openai:Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),opencode:Object.freeze(["claude-opus-5","claude-sonnet-5","gpt-5.6-sol","kimi-k3"]),"opencode-go":Object.freeze(["deepseek-v4-pro","kimi-k3","minimax-m2.7","minimax-m3"]),"quotio-openai":Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),vercel:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","deepseek-v4-flash","deepseek-v4-pro","gemini-3.6-flash","gpt-5.6-sol","gpt-5.6-terra","kimi-k3","minimax-m2.7","minimax-m3"]),xai:Object.freeze(["grok-4.20-0309-non-reasoning"])}),B=Object.freeze(Object.keys(J)),Ct=Object.freeze([...M]),Mt=Object.freeze(p.map(({name:t})=>t)),vt=Object.freeze(["ast-grep","coding-agent-sessions","data-scientist","debugging","frontend","git-master","give-me-tips","hyperplan","init-deep","lsp-setup","onboarding","programming","refactor","remove-ai-slops","review-work","start-work","ultimate-browsing","ultrawork","ulw-loop","ulw-plan","ulw-research","visual-qa"]),Lt=Object.freeze({daily_active:Object.freeze({$session_id:o,day_utc:o,reason:f(["session_start"])}),session_started:Object.freeze({$session_id:o,$os:o,$os_version:o,arch:o,cpu_count:x,default_model:f([...new Set(Object.values(J).flat()),"custom"]),default_provider:f([...B,"custom"]),memory_bucket:f(["lt_8_gb","8_15_gb","16_31_gb","32_63_gb","64_plus_gb"]),model_count:x,provider_count:x,providers:o,reason:f(["startup","reload","new","resume","fork"])}),prompt_submitted:Object.freeze({$session_id:o,input_source:f(["interactive","rpc","extension"]),invocation_stage:f(["none","first_arm","remention","post_compact_rearm"]),is_effective_ultrawork_invocation:l,is_real_user_prompt:l,is_turn_start:l,keyword_any:l,keyword_occurrence_bucket:f(["1","2","3_5","6_plus"]),keyword_ultrawork_full:l,keyword_ulw_abbrev:l,keyword_variant:f(["none","ulw","ultrawork","both"]),prompt_length_bucket:f(["lt_100","100_500","500_2000","gte_2000"]),queue_mode:f(["immediate","follow_up","steer","other"]),real_prompt_ordinal_bucket:f(["1","2_3","4_10","11_25","26_plus"]),suppression_reason:f(["none","no_keyword","extension_source","embedded_directive","skill_expansion","skill_name_only"])}),turn_completed:Object.freeze({$session_id:o,cache_read_tokens:x,cache_write_tokens:x,cost_usd:x,input_tokens:x,model_id:f([...new Set(Object.values(J).flat()),"custom"]),output_tokens:x,provider:f([...B,"custom"]),reasoning_tokens:x,total_tokens:x,turn_index:x}),skill_loaded:Object.freeze({$session_id:o,skill_name:f(vt)}),delegation_started:Object.freeze({$session_id:o,background:l,batch_size_bucket:f(["1","2_4","5_plus"]),kind:f(["category","subagent"]),name:f([...Mt,...Ct,"custom"])}),feature_used:Object.freeze({$session_id:o,feature:f(["goal_tool","team_create","memory_tool"])})}),Rn=Object.freeze(Object.fromEntries(Object.entries(Lt).map(([t,n])=>[t,Object.freeze(Object.keys(n))]))),dn=Ut();function G(){return Kt(new URL("../skills/",import.meta.url))}function Ut(){try{let t=JSON.parse(Ft(new URL("../../../package.json",import.meta.url),"utf8"));if(t!==null&&typeof t==="object"&&!Array.isArray(t)){let n=Reflect.get(t,"version");if(typeof n==="string")return n}}catch{return"0.0.0"}return"0.0.0"}import{existsSync as sn}from"node:fs";import{join as mn}from"node:path";var A=0.5,Y=8,T=500,I=3,H=30,D=0.15,X=0.25,$=90,_=7,z=86400000,S=new Set([".ts",".tsx",".js",".jsx",".py",".go",".rs",".java",".kt",".swift",".rb",".php",".c",".cpp",".cs",".scala",".lua",".ex",".exs",".zig",".dart"]),E=new Set(["node_modules",".git","dist","build","vendor",".next","__pycache__",".venv","target","coverage","third_party"]);import{existsSync as yt,readdirSync as Bt,readFileSync as Gt}from"node:fs";import{dirname as At,extname as Yt,join as e}from"node:path";function Tt(t,n){let u=n;for(;;){if(yt(e(u,"AGENTS.md")))return!0;if(u===t)return!1;let i=At(u);if(i===u)return!1;u=i}}function It(t){let n=[];return d(t,t,0,n),n}function N(t){let n=It(t);if(n.length===0)return null;let u=n.filter((c)=>c.covered).length,i=u/n.length;return{coverage:i,missingRatio:1-i,candidateDirs:n.length,coveredDirs:u}}function R(t,n){if(t===null)return!1;return t>=A}function d(t,n,u,i){if(u>I)return;let c;try{c=Bt(n,{withFileTypes:!0})}catch{return}if(u>=1){let g=c.filter((s)=>!s.isSymbolicLink()&&s.isFile()&&S.has(Yt(s.name))),r=g.reduce((s,b)=>s+Gt(e(n,b.name),"utf8").split(`
`).length,0);if(g.length>=Y||r>=T)i.push({path:n,files:g.length,loc:r,covered:Tt(t,n)})}for(let g of c){if(g.isSymbolicLink()||!g.isDirectory())continue;if(E.has(g.name))continue;d(t,e(n,g.name),u+1,i)}}import{execFileSync as _t}from"node:child_process";import{readFileSync as Et,realpathSync as cu}from"node:fs";import{extname as Nt,join as Rt,resolve as fu}from"node:path";var O=[":(exclude)AGENTS.md",":(exclude,glob)**/AGENTS.md",":(exclude).omo/init-deep.json"];function w(t,n){return _t("git",[...n],{cwd:t,encoding:"utf8"})}function dt(t){let n=0;for(let u of t)if(u==="\x00")n+=1;return n}function P(t){return w(t,["rev-parse","HEAD"]).trim()}function a(t,n){return Number(w(t,["rev-list","--count",`${n}..HEAD`]).trim())}function tt(t){return dt(w(t,["ls-files","-z"]))}function nt(t,n){return w(t,["diff","--name-only","-z","--find-renames",n,"HEAD","--",".",...O]).split("\x00").filter((i)=>i.length>0)}function ut(t,n){let i=w(t,["diff","--numstat","-z","--find-renames",n,"HEAD","--",".",...O]).split("\x00"),c=0;for(let g=0;g<i.length;g+=1){let r=i[g];if(r.length===0)continue;let[s,b,h]=r.split("\t");if(h==="")g+=2;if(s==="-"||b==="-")continue;c+=Number(s)+Number(b)}return c}function it(t){let n=w(t,["ls-files","-z"]).split("\x00").filter((i)=>i.length>0&&S.has(Nt(i))),u=0;for(let i of n){let c=Et(Rt(t,i),"utf8");for(let g of c)if(g===`
`)u+=1}return u}function gt(t,n){try{return w(t,["cat-file","-t",n]).trim()}catch{return null}}function ct(t,n){if(gt(t,n.commitSha)!=="commit")return{kind:"stale",stale:!0};let u=a(t,n.commitSha),i=nt(t,n.commitSha).length,c=tt(t),g=ut(t,n.commitSha),r=it(t);return{kind:"valid",commitsSince:u,touchedFiles:i,trackedFiles:c,touchedRatio:i/Math.max(c,1),churnLoc:g,totalLoc:r,churnLocRatio:g/Math.max(r,1),daysSince:(Date.now()-n.timestamp)/z}}function j(t,n,u,i){if(n===u)return!1;if(Date.now()<i)return!1;if(t.kind==="stale")return!0;return t.commitsSince>=H&&t.touchedRatio>=D||t.churnLocRatio>=X||t.daysSince>=$}import{execFileSync as Ot}from"node:child_process";import{createHash as Pt,randomUUID as at}from"node:crypto";import{existsSync as rt,mkdirSync as Z,readFileSync as ft,realpathSync as tn,renameSync as nn,unlinkSync as un,writeFileSync as gn}from"node:fs";import{join as m,resolve as cn}from"node:path";var st="init-deep-advisor-declined-global",mt="init-deep-advisor-declined-projects",ot="init-deep-advisor-cooldowns",xt="init-deep-advisor-proposals",rn=m(".omo","init-deep.json");function bt(t){let n=Ot("git",["rev-parse","--git-common-dir"],{cwd:t,encoding:"utf8"}).trim();return Pt("sha256").update(tn(cn(t,n))).digest("hex")}function pt(t){Z(t,{recursive:!0}),q(m(t,st),JSON.stringify({declinedAt:Date.now()}))}function lt(t){try{return rt(m(t,st))}catch{return!1}}function wt(t,n){let u=m(t,mt);Z(u,{recursive:!0}),q(m(u,n),JSON.stringify({declinedAt:Date.now()}))}function Ht(t,n){try{return rt(m(t,mt,n))}catch{return!1}}function Dt(t,n,u){let i=m(t,ot);Z(i,{recursive:!0}),q(m(i,n),JSON.stringify({until:u+_*z}))}function Xt(t,n){let u=Zt(m(t,ot,n));if(!Q(u))return 0;let i=u.until;if(typeof i!=="number"||!Number.isFinite(i)||i<0)return 0;return i}function $t(t,n,u){let i=m(t,xt);Z(i,{recursive:!0}),q(m(i,n),JSON.stringify({lastProposedHead:u,lastProposedAt:Date.now()}))}function zt(t,n){let u=Zt(m(t,xt,n));if(!Q(u))return null;let i=u.lastProposedHead;return typeof i==="string"?i:null}function St(t){let n;try{n=ft(m(t,rn),"utf8")}catch(b){return fn(b)==="ENOENT"?{kind:"missing"}:{kind:"invalid"}}let u;try{u=JSON.parse(n)}catch{return{kind:"invalid"}}if(!Q(u))return{kind:"invalid"};let{commitSha:i,fileCount:c,loc:g,timestamp:r,mode:s}=u;if(typeof i!=="string")return{kind:"invalid"};if(!k(c)||!k(g)||!k(r))return{kind:"invalid"};if(s!=="local"&&s!=="committed")return{kind:"invalid"};return{kind:"valid",snapshot:{commitSha:i,fileCount:c,loc:g,timestamp:r,mode:s}}}function q(t,n){let u=`${t}.${process.pid}.${at()}.tmp`;try{gn(u,n,{mode:384}),nn(u,t)}finally{try{un(u)}catch{}}}function Zt(t){try{return JSON.parse(ft(t,"utf8"))}catch{return}}function k(t){return typeof t==="number"&&Number.isFinite(t)&&t>=0}function fn(t){if(!Q(t))return;let n=t.code;return typeof n==="string"?n:void 0}function Q(t){return t!==null&&typeof t==="object"&&!Array.isArray(t)}function qt(t,n,u,i){let c=St(t);if(c.kind==="missing"){let r=N(t);if(!R(r?.missingRatio??null,sn(mn(t,"AGENTS.md"))))return null;if(n===u||Date.now()<i)return null;return{trigger:"coverage-gap",coverage:{missingRatio:r.missingRatio,candidateDirs:r.candidateDirs,coveredDirs:r.coveredDirs}}}if(c.kind==="invalid")return on(n,u,i);let g=ct(t,c.snapshot);if(!j(g,n,u,i))return null;if(g.kind==="stale")return{trigger:"snapshot-invalid",drift:{stale:!0}};return xn(g)}function on(t,n,u){if(!j({kind:"stale",stale:!0},t,n,u))return null;return{trigger:"snapshot-invalid",drift:{stale:!0}}}function xn(t){let n={commitsSince:t.commitsSince,touchedRatio:t.touchedRatio,churnLocRatio:t.churnLocRatio,daysSince:t.daysSince};if(t.commitsSince>=H&&t.touchedRatio>=D)return{trigger:"commit-and-touch",drift:n};if(t.churnLocRatio>=X)return{trigger:"loc-churn",drift:n};if(t.daysSince>=$)return{trigger:"snapshot-age",drift:n};throw Error("eligible drift has no trigger")}function Qt(t,n,u){if(n.trigger==="coverage-gap")return{repo:t,trigger:n.trigger,coverage:n.coverage,drift:null,suggestedMode:u};if(n.trigger==="snapshot-invalid")return{repo:t,trigger:n.trigger,coverage:null,drift:n.drift,suggestedMode:u};return{repo:t,trigger:n.trigger,coverage:null,drift:n.drift,suggestedMode:u}}var pn=["Run now","Skip this time","Never in this project","Never anywhere"];async function Mu(t,n,u){let{root:i,stateDir:c}=u,g=bt(i);if(lt(c))return;if(Ht(c,g))return;let r=Xt(c,g);if(Date.now()<r)return;let s=P(i),b=qt(i,s,zt(c,g),r);if(b===null)return;$t(c,g,s),await new Promise((ht)=>setTimeout(ht,0));let h=await n.ui?.select("Init-deep",[...pn],{timeout:60000});ln(h,t,c,g,i,b)}function ln(t,n,u,i,c,g){if(t==="Run now"){let r=G();n.sendMessage({customType:"omo-init-deep-advisor:run",content:`Read the init-deep skill at ${r}/init-deep/SKILL.md with the read tool and follow it.`,display:!1},{triggerTurn:!0,deliverAs:"followUp"}),n.appendEntry?.("omo-init-deep-advisor:proposed",Qt(i,g,wn(c)));return}if(t==="Skip this time"||t===void 0){Dt(u,i,Date.now());return}if(t==="Never in this project"){wt(u,i);return}if(t==="Never anywhere")pt(u)}function wn(t){try{return bn("git",["ls-files","--error-unmatch","AGENTS.md"],{cwd:t,encoding:"utf8",stdio:["ignore","pipe","ignore"]}),"committed"}catch{return"local"}}export{Mu as runAdvisorAfterPreflight};
